...
# above command is used to make the script executable
# This script cleans up the current Flutter project by removing build artifacts
...
echo "📦 Building the Flutter APK in release mode..."

flutter build apk --release
if [ $? -eq 0 ]; then
    echo "✅ APK built successfully."
else
    echo "⚠️ Failed to build the APK."
fi
